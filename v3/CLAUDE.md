...
make test    # 255 v2 vitest + v3 vitest (382 as of build-plan step 12: 46 corpus-compiler + 336 engine) + 47 v2/api PHPUnit + 40 v3/api PHPUnit (build-plan step 14: +15 events ingestion/pull)
