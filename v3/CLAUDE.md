...
make test    # 255 v2 vitest + v3 vitest (441 as of build-plan step 16 in progress, s1+cloze+junction kernels: 52 corpus-compiler + 374 engine + 15 fold-runner) + 47 v2/api PHPUnit + 71 v3/api PHPUnit
