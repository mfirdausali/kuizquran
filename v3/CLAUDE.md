...
make test    # 255 v2 vitest + v3 vitest (404 as of build-plan step 15 done: 52 corpus-compiler + 337 engine + 15 fold-runner) + 47 v2/api PHPUnit + 71 v3/api PHPUnit (B1+B3 closed)
