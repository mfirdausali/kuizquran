...
//
// Ported verbatim from v1/packages/corpus-compiler/src/prdRank.ts — no
// surah-parameterization needed, this is pure text/root comparison.
 ...
 * sharing a substantial common prefix (a plausible suffix inflection, e.g. a
 * plural-masculine vs plural-feminine verb ending). Operates on normalized
 * skeletons.
 */
...
export interface RankInput {
  ...
  distractorRoot: string | null; // may be null (only known if the distractor is a same-surah word)
  srcType: SrcType;
}
